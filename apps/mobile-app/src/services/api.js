...
http.interceptors.response.use(
  ...
  async (error) => {
    ...
    // Sessão expirada/inválida: limpa o SecureStore e devolve o usuário ao
...
async function encerrarSessao() {
  await SecureStore.deleteItemAsync(TOKEN_KEY); await SecureStore.deleteItemAsync(USUARIO_KEY);
}
